...
<c:set var="getTableStaColumnData"  value="${ctx}/common/SYSLOG_LOGIN/getTableColumnData.do"  scope="page" />
<c:set var="initTable" value="${ctx}/syslog/loginLog/loginLog/initTable.do" scope="request" />

<!DOCTYPE html>
<html lang="en">
<head>
<title>中移动流量采集监测系统-系统日志-登录日志</title>
    ...
    <div class="con regional">
        <div class="frame">
            <div class="title">
                ...
                <span>登录日志</span>
               <%--  <sec:authorize ifAllGranted="ROLE_SYSTEM_LOGIN_LOG_QUERY">
