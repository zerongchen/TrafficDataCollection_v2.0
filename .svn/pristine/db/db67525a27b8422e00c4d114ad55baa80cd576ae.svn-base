...
@Controller
@RequestMapping(value = "/serviceConfiguration/baseResPool")
public class BaseResPoolManageController {
	...
	public String index(HttpServletRequest request){
		...
		return "serviceConfiguration/baserespoolManage";
	}
	...
	public String detail(HttpServletRequest request){
		...
		return "serviceConfiguration/baserespoolDetail";
	}
	// 查询数据
	@Secured({ "ROLE_WELCOME" })
