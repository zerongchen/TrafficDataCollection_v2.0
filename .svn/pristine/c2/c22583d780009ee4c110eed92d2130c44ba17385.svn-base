...
<c:set var="getTableStaColumnData"  value="${ctx}/common/FLOW_DIRECTION_CARRIER_FLOW_STA/getTableColumnData.do"  scope="page" />
<c:set var="getTableTrendColumnData"  value="${ctx}/common/FLOW_DIRECTION_CARRIER_FLOW_TREND/getTableColumnData.do"  scope="page" />
<c:set var="updateStaColumnUser"  value="${ctx}/common/FLOW_DIRECTION_CARRIER_FLOW_STA/updateColumnUser.do" scope="request" />
<c:set var="updateTrendColumnUser"  value="${ctx}/common/FLOW_DIRECTION_CARRIER_FLOW_TREND/updateColumnUser.do" scope="request" />
<c:set var="initStaTable" value="${ctx}/traffic/trafficAnalysis/carrier/initStaTable.do" scope="request" />
<c:set var="initTrendTable" value="${ctx}/traffic/trafficAnalysis/carrier/initTrendTable.do" scope="request" />
<c:set var="exportStatistic" value="${ctx}/traffic/trafficAnalysis/carrier/exportStatistic.do" scope="request" />
<c:set var="exportTrend" value="${ctx}/traffic/trafficAnalysis/carrier/exportTrend.do" scope="request" />
<c:set var="getCarrierMultSelectData" value="${ctx}/common/selectCarrier.do" scope="request" />
<!DOCTYPE html>
<html lang="en">
<head>
<title>中移动流量采集监测系统-流向分析-运营商来源</title>
...
queryTableName = "REPORT_CARRIER_QUALITY";
var setting = {
		edit: {
			enable: false,
			showRenameBtn: false
...
<div class="con computer_room">
  <div class="frame">
    ...
    <div class="computer_room">
      ...
      <sec:authorize ifAllGranted="ROLE_OPERATOR_SOURCE_QUERY"> 
      <form id="searchForm"> 
     ...
     <div class="regional">
        ...
        <div id="trend" >
        <div class="table-title"> <a>运营商流量排名</a>
         ...
         <div id = "div_01">
                            <div id="page01">
                                <div id="chart_3" style="float:left;width:851px;height:250px; -webkit-tap-highlight-color: transparent; -webkit-user-select: none; cursor: default; background-color: rgba(0, 0, 0, 0);"></div>
                            </div>
        ...
        <div class="table-title"> <a>运营商流量统计</a>
        <div class="w95">
         
            <sec:authorize ifAllGranted="ROLE_OPERATOR_SOURCE_EXPORT">
...
<script src="${scriptPath}/view/traffic/trafficAnalysis/carrier_statistics.js" type="text/javascript"></script>
<script src="${scriptPath}/view/traffic/trafficAnalysis/carrier_trend.js" type="text/javascript"></script>
</body>
</html>