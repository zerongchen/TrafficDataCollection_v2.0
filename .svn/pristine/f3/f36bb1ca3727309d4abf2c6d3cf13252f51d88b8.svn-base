...
<c:set var="exportLayerTrend"
	...
	<div id = "div_layer"  style = "display:none;" class="table-title">
        ...
        <div id="chart_layer" >
	        ...
	        <div id="layer_chart" style="width: 100%;margin:30px auto 0;height:300px; -webkit-tap-highlight-color: transparent; -webkit-user-select: none; cursor: default; background-color: rgba(0, 0, 0, 0);">
	        </div>
        </div>
    ...
    (function(){
		...
		$("#export_layer").on("click", function(e){
			...
			data.queryPosition=queryPosition_s;
			$.download({url:exportLayerTrendUrl, data:data});
		});
    	function searchLayer(provinceId){
    		queryPosition_s=provinceId;
    		...
    		$('#appTable_layer').bootstrapTable("destroy").bootstrapTable({
    			...
    			$("#chart_layer_option").append(chartDOption).on("change", function(e){
