...
<c:set var="getTableStaColumnData"  value="${ctx}/common/REGIONPRODUCT_BUSINESS_ANALYSIS/getTableColumnData.do"  scope="page" />
<c:set var="updateStaColumnUser"  value="${ctx}/common/REGIONPRODUCT_BUSINESS_ANALYSIS/updateColumnUser.do" scope="request" />
<c:set var="initStaTable" value="${ctx}/traffic/businessAnalysis/regionProduct/initStaTable.do" scope="request" />
<c:set var="exportStatistic" value="${ctx}/traffic/businessAnalysis/regionProduct/exportStatistic.do" scope="request" />

<!DOCTYPE html>
<html lang="en">
<head>
<title>中移动流量采集监测系统-业务分析-业务地域分布</title>
    ...
    <div class="con quality_regional">
        <div class="frame">
            <div class="title">
                ...
                <span>业务地域分布</span>
                <sec:authorize ifAllGranted="ROLE_PRODUCT_ANALYSIS_REGIONPRODUCT_QUERY">
                <button class="fr drop_down">查询</button>
            	</sec:authorize>
            </div>
            <sec:authorize ifAllGranted="ROLE_PRODUCT_ANALYSIS_REGIONPRODUCT_EXPORT">
            <form id="searchForm">  
          <div class="time_search" style = "display:none;">
            ...
            <div class="fr">
             ...
             <div class="fl option">
                <tdc:selector switches = "4"></tdc:selector>
                ...
                <div class="c-traffic fl">
                    <div id="trend">
                        <div class="table-title oh">
                            ...
                            <div class="w100">
                                <div id="chart_1" style="float:left;margin:10px auto;width:40%;height:350px; -webkit-tap-highlight-color: transparent; -webkit-user-select: none; cursor: default; background-color: rgba(0, 0, 0, 0);"></div>
                                <div id="chart_2" style="float:left;margin:10px auto;width:60%;height:350px; -webkit-tap-highlight-color: transparent; -webkit-user-select: none; cursor: default; background-color: rgba(0, 0, 0, 0);"></div>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    <script src="${scriptPath}/view/businessAnalysis/regionProductAnalysis.js" type="text/javascript"></script>            
</body>
</html>