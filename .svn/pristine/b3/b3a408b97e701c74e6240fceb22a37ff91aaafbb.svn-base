...
<c:set var="getTableStaColumnData"  value="${ctx}/common/IP_QUALITY_FLOW_STA/getTableColumnData.do"  scope="page" />
<c:set var="getTableTrendColumnData"  value="${ctx}/common/IP_QUALITY_FLOW_TREND/getTableColumnData.do"  scope="page" />
<c:set var="updateStaColumnUser"  value="${ctx}/common/IP_QUALITY_FLOW_STA/updateColumnUser.do" scope="request" />
<c:set var="updateTrendColumnUser"  value="${ctx}/common/IP_QUALITY_FLOW_TREND/updateColumnUser.do" scope="request" />
<c:set var="initStaTable" value="${ctx}/traffic/trafficAnalysis/ipAddress/initStaTable.do" scope="request" />
<c:set var="initTrendTable" value="${ctx}/traffic/trafficAnalysis/ipAddress/initTrendTable.do" scope="request" />
<c:set var="exportStatistic" value="${ctx}/traffic/trafficAnalysis/ipAddress/exportStatistic.do" scope="request" />
<c:set var="exportTrend" value="${ctx}/traffic/trafficAnalysis/ipAddress/exportTrend.do" scope="request" />
<c:set var="getDestIpMultSelectUrl" value="${ctx}/common/selectDestIp.do" scope="request" />
<!DOCTYPE html>
<html lang="en">
<head>
<title>中移动流量采集监测系统-流向分析-IP地址</title>
...
queryTableName = "REPORT_IP_QUALITY";
var setting = {
		edit: {
			enable: false,
			showRenameBtn: false
    ...
    <div class="con computer_room">
        <div class="frame">
            <div class="title">
                ...
                <span>IP地址</span>
                <!--<sec:authorize ifAllGranted="ROLE_IP_ADDRESS_QUERY">
		...
		<ul id="treeSelect" class="ztree"></ul>
          ...
          <div class="time_search" >
                ...
                <div class="time_scope fl"  style = "display:none;">
                        ...
                        <input type = "hidden"  id = "hid_queryDestIp"  name = "queryDestIp"  value = ""  />
          ...
          <%--  <div class="fl option">
                ...
                <tdc:destIpMultSelect domId="sel_destIp" domName="queryDestIp" getDestIpMultSelectUrl="${getDestIpMultSelectUrl}" />
                <div>
            <label for="">目的IP地址：</label>
            <input type = "text"  id = "text_queryDestIp"  name = "queryDestIp"  value = ""  />
                ...
                <div id="trend">
                    <div class="table-title">
                      ...
                      <div class="table-title">
                        <a>目的IP地址流量统计</a>
                        <div class="w951">
                        <sec:authorize ifAllGranted="ROLE_IP_ADDRESS_EXPORT">
...
<div id = "div_layer"  style = "display:none;" class="table-title">
    ...
    <script src="${scriptPath}/view/traffic/trafficAnalysis/ipAddress_statistics.js" type="text/javascript"></script>
    <script src="${scriptPath}/view/traffic/trafficAnalysis/ipAddress_trend.js" type="text/javascript"></script>
