...
public final class IpLimit {
    ...
    public static void main(String args[]){
        ...
        */
    	System.out.println(IpConvert.stringToBigInt("e80:a5eb:8fc8::7ec6:8027"));
        System.out.println(IpLimit.StringToBigInt("e80:a5eb:8fc8::7ec6:8027"));
        System.out.println(IpLimit.StringToBigInt("10.210.71.255"));
        //单IP限制必须写全两个
        String[][] iplimit1 ={
