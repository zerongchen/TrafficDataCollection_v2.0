...
import com.aotain.tdc.service.traffic.CarrierService;

@Controller
@RequestMapping(value = "/traffic/trafficAnalysis/carrier")
public class CarrierFlowController {
	...
	public String index(HttpServletRequest request){
		...
		return "traffic/trafficAnalysis/carrier";
	}
	
	 //查询统计数据
    @Secured({"ROLE_OPERATOR_SOURCE_QUERY"})
	...
	public PageResult<HashMap<String, String>> initStaTable(BaseDTO dto){
		...
		carrierService.getTableColumns(dto);
	...
	public PageResult<HashMap<String, String>> initTrendTable(BaseDTO dto) throws ExecutionException{
    	dto.setIsQueryDateTime(LocalConfig.getInstance().getIsQueryDateTime());
    	carrierService.getTableTrendColumns(dto);
		@SuppressWarnings("unchecked")
		List<HashMap<String, String>> list = (List<HashMap<String, String>>) dto.getResultList();
    ...
    @Secured({"ROLE_OPERATOR_SOURCE_EXPORT"})
    @SuppressWarnings("unchecked")
