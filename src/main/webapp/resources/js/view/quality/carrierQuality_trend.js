...
//		tableColumnData = $('#trendTable').bootstrapTable("getOptions").columns;
	...
	function search() {
		...
		getTableColumnData(getTableColumnDataUrl);
		tableColumnData.splice(1,0,{field: 'trendAnalysis',title: '运营商',width: 80,align: 'center',valign: 'middle',formatter: operateFormatter, events: operateEvents, switchable:false});
