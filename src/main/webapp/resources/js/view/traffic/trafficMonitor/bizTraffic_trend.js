...
function search() {
	getTableColumnData(getTableColumnDataUrl);
	tableColumnData.splice(1,0,{field: 'trendAnalysis',title: '业务名称',width: 80,align: 'center',valign: 'middle',formatter: operateFormatter, events: operateEvents, switchable:false});
