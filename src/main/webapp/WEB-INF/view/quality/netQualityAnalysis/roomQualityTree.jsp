...
<script type="text/javascript">
	(function() {
		$(function() {
			$("#c-height").css("height", document.body.scrollHeight-172);
			...
			$("#queryFieldName_1").val("SERVERBUILD_ID");
		...
		function onClick(e, treeId, treeNode){
			...
			var queryFieldName = "";
			if($("#queryServerBuildId_1").val() == ""){
				queryFieldName = "SERVERBUILD_ID";
			}else if($("#queryServerRoomId_1").val() == ""){
				queryFieldName = "SERVERROOM_ID";
			}else if($("#queryClassId_1").val() == ""){
				queryFieldName = "SERVERROOM_ID";
			}else{
				queryFieldName = "SERVERROOM_ID";
			}
			$("#queryFieldName_1").val(queryFieldName);
			$(".table-title:eq(0) a").html(treeObj.getSelectedNodes()[0].name + "流量趋势");
			$(".table-title:eq(1) a").html(treeObj.getSelectedNodes()[0].name + "流量占比");
