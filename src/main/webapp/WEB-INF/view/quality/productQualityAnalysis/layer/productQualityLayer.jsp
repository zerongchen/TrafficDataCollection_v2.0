...
<c:set var="exportLayerTrend"
    ...
    (function(){
		...
		$("#export_layer").on("click", function(e){
			var tableColumnData = $('#appTable_layer').bootstrapTable("getOptions").columns[0];
			var data = new Object();
    	...
    	function searchLayer(column,bizid){
    		var tableColumnData = getTableColumnData(getTrendTableColumnDataUrl);
    		tableColumnData.splice(1,0,column);
