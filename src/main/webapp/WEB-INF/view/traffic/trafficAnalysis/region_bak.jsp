...
<c:set var="getTableStaColumnData"  value="${ctx}/common/FLOW_DIRECTION_REGION_FLOW_STA/getTableColumnData.do"  scope="page" />
<c:set var="getTableTrendColumnData"  value="${ctx}/common/FLOW_DIRECTION_REGION_FLOW_TREND/getTableColumnData.do"  scope="page" />
<c:set var="updateStaColumnUser"  value="${ctx}/common/FLOW_DIRECTION_REGION_FLOW_STA/updateColumnUser.do" scope="request" />
<c:set var="updateTrendColumnUser"  value="${ctx}/common/FLOW_DIRECTION_REGION_FLOW_TREND/updateColumnUser.do" scope="request" />
<c:set var="initStaTable" value="${ctx}/traffic/trafficAnalysis/region/initStaTable.do" scope="request" />
<c:set var="initTrendTable" value="${ctx}/traffic/trafficAnalysis/region/initTrendTable.do" scope="request" />
<c:set var="exportStatistic" value="${ctx}/traffic/trafficAnalysis/region/exportStatistic.do" scope="request" />
<c:set var="exportTrend" value="${ctx}/traffic/trafficAnalysis/region/exportTrend.do" scope="request" />
<!DOCTYPE html>
<html lang="en">
<head>
<title>中移动流量采集监测系统-流向分析-地域来源</title>
...
<body>
    ...
    <div class="con regional">
        <div class="frame">
          ...
          <div class="time_search" style = "display:none;">
                ...
                <div class="time_scope fl"  style = "display:none;">
                        ...
                        <input type = "hidden"  name = "queryBizID"    value = "-1"  />
                    </div>
            </div>
            <div class="fr">
            ...
            <%-- <div class="fl option">
                <tdc:selector switches = "10"></tdc:selector>
        ...
        <div class="regional">
            <div class="c-traffic fl">
                ...
                <div id="trend">
                     <div class="table-title oh">
                        ...
                        <div id = "div_01">
                            <div id="page01">
                                <div id="chart_1" style="float:left;width:50%;height:560px; -webkit-tap-highlight-color: transparent; -webkit-user-select: none; cursor: default; background-color: rgba(0, 0, 0, 0);"></div>
                                <div style="float:left;width:45%;height:400px;  overflow-y:auto;">
                                	<div id="chart_3" style="float: left; margin: 10px auto; width: 100%; height: 1300px;-webkit-tap-highlight-color: transparent; -webkit-user-select: none; cursor: default; background-color: rgba(0, 0, 0, 0);">
									</div>
                                </div>
                            </div>
                        ...
                        <div class="table-title">
                         <a>地域流量统计</a>
                        <div class="w95">
                        <sec:authorize ifAllGranted="ROLE_AREA_SOURCE_EXPROT">
           ...
           <div class="table-title">
                    <a>趋势图表</a>
                    <div id="chart_2" style="width:80%;margin:20px auto 0;height:300px; -webkit-tap-highlight-color: transparent; -webkit-user-select: none; cursor: default; background-color: rgba(0, 0, 0, 0);"></div>
...
<div id = "div_layer"  style = "display:none;" class="table-title">
    ...
    <script type="text/javascript">
        $(function() {
       		...
       		//$("#hid_sdate").val(formatDate(getDate(0,0,-2)));
  			//$("#hid_edate").val(formatDate(getDate(0,0,0)));
  			
  			$("#hid_sdate").val(getDate(0,0,-2));
  			$("#hid_edate").val(getDate(0,0,0));
       		
  			$("input[name='queryBizID']").val("-1");
       		$("#class").val(-1);  
       		$("#catalog").val(-1);  
       		$("#product").val(-1);  
       		...
       		$(".fl a").bind("click",function(){
       			...
       			switch ($(this).html()){
	   				...
	   				case "最近48小时" :$(".time_scope").hide();$("input[name='queryTableName']").val(queryTableName+"_MIN");$("#hid_sdate").val(getDate(0,0,-2));$("#hid_edate").val(getDate(0,0,0));break;
	   				case "最近7天" : $(".time_scope").hide();$("input[name='queryTableName']").val(queryTableName+"_MIN");$("#hid_sdate").val(getDate(0,0,-7));$("#hid_edate").val(getDate(0,0,0));break;
	   				case "最近30天" : $(".time_scope").hide();$("input[name='queryTableName']").val(queryTableName+"_H");$("#hid_sdate").val(formatDate(getDate(0,0,-30),"H"));$("#hid_edate").val(formatDate(getDate(0,0,0),"H"));break;
    ...
    <script src="${scriptPath}/view/traffic/trafficAnalysis/region_statistics.js" type="text/javascript"></script>
    <script src="${scriptPath}/view/traffic/trafficAnalysis/region_trend.js" type="text/javascript"></script>
