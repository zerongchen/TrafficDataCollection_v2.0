...
queryTableName = "REPORT_PROVINCE_QUALITY";
var setting = {
		edit: {
			enable: false,
			showRenameBtn: false
...
<div class="con computer_room">
  <div class="frame">
    ...
    <div class="computer_room">
      ...
      <div class="fl tsa" id = "time_scope"> 
      ...
      <!-- <div class="fr searchBtn" id = "searchBtn_div" style = "display:none;">
        <button class="search_button fr"  id="searchBtn"  type="button">查询</button>
      </div> -->
    </div>
    </form>
     ...
     <div class="regional">
        ...
        <div id="trend" >
        <div class="table-title"> <a>地域流量排名</a>
         ...
         <div id = "div_01">
                            <div id="page01">
                                <div id="chart_1" style="float:left;width:65%;height:520px; top:10px; -webkit-tap-highlight-color: transparent; -webkit-user-select: none; cursor: default; background-color: rgba(0, 0, 0, 0);"></div>
                                <div style="float:left;width:35%;height:500px;  overflow-y:auto;">
                                	<div id="chart_3" style="float: left; margin: 10px auto; width: 100%; height: 1230px;-webkit-tap-highlight-color: transparent; -webkit-user-select: none; cursor: default; background-color: rgba(0, 0, 0, 0);">
									</div>
                                </div>
                            </div>
        ...
        <div class="table-title"> <a>地域流量统计</a>
        <div class="w95">          
            <sec:authorize ifAllGranted="ROLE_AREA_SOURCE_EXPORT">
        ...
        <div  id="statistical"  style = "display:none;" > 
           <div class="table-title">
                    ...
                    <div id="chart_2" style="width:100%;height:250px; -webkit-tap-highlight-color: transparent; -webkit-user-select: none; cursor: default; background-color: rgba(0, 0, 0, 0);"></div>
                     </div>   
                </div>
                 <div class="table-title">
                 <a>趋势报表</a>
